...
- **Compute (EC2)**: An EC2 instance deployed in the public tier using the official EC2 module. It automatically creates and attaches an IAM Instance Profile granting read access to the RDS master password secret. Additionally, a TLS private key is generated, stored in AWS Secrets Manager, and used to create an EC2 key pair for secure access.
